...
export class NewPageComponent implements OnInit{
  ...
  //estoy creando un getter para transformar mi data
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.
      ...
      .subscribe( hero => {
        ...
        this.heroForm.reset( hero ); //este metodo esta diciendo que le asigne el valor de el hero
        return;
      })
  ...
  onSubmit(): void {
    ...
    this.heroService.addHero(this.currentHero)
      .subscribe( hero => {
        ...
        return this.router.navigate(['/heroes/edit', hero.id ]);
      })
  }
